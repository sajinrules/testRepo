...
Thanks for purchasing Metronic 3.9.0 and joining our awesome community! Start browsing the theme just open start.html in your browser.
...
- _resources      			keenth			- Contains of commercially licensed and free stock photos and the theme's PSD files.
...
- theme_rtl   							- Metronic HTML theme's main folder for RTL(Right to Left(RTL)writing support. E.g: arabic, iranian).
	...
	- templates       					- Contains of admin and frontend theme template pages.
		...
		- admin4       					- Contains of admin 5 theme templates pages.
