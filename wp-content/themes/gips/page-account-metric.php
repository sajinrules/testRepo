...
<div class="page-content-wrapper">
					...
					<div class="profile-sidebar" style="width:250px;">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								...
								<!--<img src="http://wecross.dev.wecross.nl/wp-content/uploads/ultimatemember/<?php echo $wp_user->ID; ?>/profile_photo-190.jpg" class="img-responsive" alt="">-->
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
  ...
  <?php //echo $curUrl;?>
	<li class="active">
	  <a href="#tab_1_1" data-toggle="tab" onclick="location.href = $(this).attr('href')+'?q=personal';return false" id="personalInfo">Account</a>
	</li>
	<li>
	  <a href="#tab_1_2" data-toggle="tab" onclick="location.href = $(this).attr('href')+'?q=avatar';return false" id="avatar">Foto</a>
	</li>
	<li>
	  <a href="#tab_1_3" data-toggle="tab" onclick="location.href = $(this).attr('href')+'?q=password';return false" id="password">Wachtwoord</a>
	</li>
	<li>
	  <a href="#tab_1_4" data-toggle="tab" onclick="location.href = $(this).attr('href')+'?q=privacy';return false" id="privacy">Privacy</a>
	</li>
	<!--
	<li>
	...
	<li>
	  <a href="#tab_1_6" data-toggle="tab" onclick="location.href = $(this).attr('href')+'?q=delete';return false" id="delete">Verwijderen</a>
	</li>
  </ul>
</div>
	  ...
	  <form action="" method="post">
		<div class="margin-top-10">
		  <input type="submit" name="SubmitButton"  class="btn green-haze"/> 
			<a href="javascript:;" class="btn default">Annuleer </a>
			<a href="javascript:;" class="btn default fileinput-exists" class="um-reset-profile-photo" data-dismiss="fileinput" data-user_id="2">Verwijder </a>
		</div>
	  </form>							
	  <!--		
	  ...
	  <?php $user_ID = get_current_user_id();?> 
				<form action="#" method="POST" id="resetPassword">
					<div class="form-group">
						<label class="control-label" id="curpwd_label">Huidig Wachtwoord</label>
						<input type="password" class="form-control" name="cur_pwd" id="cur_pwd">
					</div>
					<div class="form-group">
						<label class="control-label" id="newpwd_label">Nieuw Wachtwoord</label>
						<input type="password" class="form-control" name="new_pwd" id="new_pwd">
					</div>
					<div class="form-group">
						<label class="control-label" id="repwd_label">Herhaal Nieuw Wachtwoord</label>
						<input type="password" class="form-control" name="re_pwd" id="re_pwd">
					</div>
					<div class="margin-top-10">
					  <input type="button" id="resetPwd"  class="btn green-haze" name="save_data" value="Verander Wachtwoord " />
