<?php
/**
 * Template Name: Professionals > Browser
 *
					...
					<div class="portlet light bordered">
						...
						<div class="table-scrollable">
							...
							<tr role="row" class="odd">
								<td class="sorting_1"> <a href='/professional/detail'>Naam Professional</a> </td>
								<td>Naam Organisatie van de Professional</td>
								<td>Gekoppeld aan gezinnen</td>
