<?php
/**
 * Template Name: Campaigns > Insights > Revenue
 *
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Insights Revenue <small>...</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
				...
				<div class='col-md-12'>
					<div class='portlet light'>
						<div class='portlet-body'>
							...
							<div class='row'>
								<div class='col-md-10'>
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption font-red-sunglo">
												All Channels this month - cumulative
											</div>
											<div class="actions">
								...
								<div class='col-md-2'>
									<div class="portlet light bordered">
										...
										<div class="portlet-body">
											...
											<!-- BEGIN INTERACTIVE CHART PORTLET-->
											<div class="portlet-body">
													<img src="<?php bloginfo('template_url'); ?>/images/chart2.png" width="100%">
												</div>											
											</div>
											<!-- END INTERACTIVE CHART PORTLET-->
										</div>
							...
							<h3>Breakdown per channel</h3>
							<hr/>
							<h4>Adwords | Display</h4><br/>
							<!-- row data -->
							<div class='row'>
								<div class='col-md-3'>
									<div class="portlet light bordered">
							...
							<h4>Adwords | Search (Generic)</h4><br/>
							<!-- row data -->
							<div class='row'>
								<div class='col-md-3'>
									<div class="portlet light bordered">
