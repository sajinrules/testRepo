<?php
/**
 * Template Name: Campaigns > Insights > Transactions
 *
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Insights Transactions <small>...</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
							...
							<div class='row'>
								<div class='col-md-10'>
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption font-red-sunglo">
												All Channels - Cumulative
											</div>
											<div class="actions">
												<div class="btn-group btn-group-devided" data-toggle="buttons">
													<label class="btn btn-circle btn-transparent grey-salsa btn-sm active">
													<input type="radio" name="options" class="toggle" id="option1">Transactions</label>
													<label class="btn btn-circle btn-transparent grey-salsa btn-sm">
													<input type="radio" name="options" class="toggle" id="option2">Tickets</label>
								...
								<div class='col-md-2'>
									<div class="dashboard-stat2">
										<div class="display">
											<div class="number">
												<h3 class="font-red-haze">- 10 <small class="font-red-haze">%</small></h3>
									...
									<div class="dashboard-stat2">
										<div class="display">
											<div class="number">
												<h3 class="font-green-sharp">+ 1 <small class="font-green-sharp">%</small></h3>
												<small>Costs per transaction</small>
											</div>
										</div>
										<div class="progress-info">
							<div class="progress">
								...
								<div class="status-number">
									...
									<div class="dashboard-stat2">
										<div class="display">
											<div class="number">
												<h3 class="font-green-sharp">+ 1 <small class="font-green-sharp">%</small></h3>
												<small>Costs per transaction (paid)</small>
											</div>
										</div>									
									</div>								
								</div>	
								...
								<div class='col-md-12'>
									<div class="portlet light">
										...
										<div class="portlet-body">
											...
											<!-- BEGIN INTERACTIVE CHART PORTLET-->
											<div class="portlet-body">
												<img src="<?php bloginfo('template_url'); ?>/images/chart4.png" width='100%'>
											</div>											
										</div>
										<!-- END INTERACTIVE CHART PORTLET-->
									</div>
