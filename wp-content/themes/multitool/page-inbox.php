						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
									<span class="caption-subject font-green-sharp bold uppercase">Inbox </span>
							...
							<div class="portlet-body">
								<div class="row">
										...
										<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 800px;"><div class="scroller" style="max-height: 800px; overflow: hidden; width: auto; height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7" data-initialized="1">
											<div class="todo-tasklist">
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar4.jpg" width="27px" height="27px">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-red">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar5.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar9.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
														 Slider Redesign
													</div>
													<div class="todo-tasklist-controls pull-left">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-blue">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar6.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-purple">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar7.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
												...
												<div class="todo-tasklist-item todo-tasklist-item-border-yellow">
													<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar8.jpg" width="27px" height="27px">
													<div class="todo-tasklist-item-title">
														 New Search Keywords
													</div>
													<div class="todo-tasklist-item-text">
									...
									<div class="col-md-7 col-sm-8">
													...
													<div class="form-group">
														<div class="col-md-8 col-sm-8">
															<div class="todo-taskbody-user">
																<img class="todo-userpic pull-left" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar6.jpg" width="50px" height="50px">
																...
																<div class="col-md-12">
																	<ul class="media-list">
																		<li class="media">
																			...
																			<img class="todo-userpic" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar8.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				...
																				<div class="media">
																					<a class="pull-left" href="javascript:;">
																					<img class="todo-userpic" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar4.jpg" width="27px" height="27px">
																					</a>
																		...
																		<li class="media">
																			<a class="pull-left" href="javascript:;">
																			<img class="todo-userpic" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar5.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				<button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
																				<p class="todo-comment-head">
																		...
																		<li class="media">
																			<a class="pull-left" href="javascript:;">
																			<img class="todo-userpic" src="<?php bloginfo('template_url'); ?>/assets/admin/layout4/img/avatar6.jpg" width="27px" height="27px">
																			</a>
																			<div class="media-body todo-comment">
																				<button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
																				<p class="todo-comment-head">
										...
										</div><div class="slimScrollBar" style="background-color: rgb(218, 227, 231); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 1px; height: 614.2034548944338px; background-position: initial initial; background-repeat: initial initial;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; background-color: rgb(234, 234, 234); opacity: 0.2; z-index: 90; right: 1px; background-position: initial initial; background-repeat: initial initial;"></div></div>
									</div>
								</div>
							</div>
						</div>
