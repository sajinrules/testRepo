<?php
/**
 * Template Name: We Cross Social Compose
 *
 * The template and functionality for displaying social inbox on frontend
 * @package WordPress
...
?><div class="wrap">
	<h2>
		<?php _e('Simple Social Compose','simple_social_inbox');?>
	</h2>

<div class="metabox-holder">
<div id="simple_social_compose" class="postbox " >
	<div class="inside">

	<?php
	$SimpleSocial = SimpleSocialInbox::getInstance();
	?>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table class="" id="simple_social_compose_table">
			<thead>
				<tr>
		    ...
		    <tr>
			    ...
			    <td colspan="2" class="social_column last">
				    ...
				    <div id="schedule_send_later_box" style="display:none;">
					    <input type="text" name="schedule_date" value="" class="simple_social_date_field">
					    <input type="text" name="schedule_time" value="" class="simple_social_time_field">
		    ...
		    <tr>
			    ...
			    <td colspan="2" class="social_column last">
				    ...
				    <br/><small>If enabled, all links in above messages will be automatically changed (eg: <?php
						...
						$new_link .= _SIMPLE_SOCIAL_TWITTER_LINK_REWRITE_PREFIX . '=123ABC';
	    ...
	    <p class="submit">
				<input name="butt_send" type="submit" class="button-primary"
				       value="<?php echo esc_attr( __( 'Send Message', 'simple_social_inbox' ) ); ?>"/>
		</p>
	    ...
	    jQuery(function(){
		    ...
		    jQuery('#message_link_url').change(function(){
			    ...
			    jQuery.ajax({
				    ...
				    data: {
					    action:'simple_social_fb_url_info',
					    url: jQuery(this).val(),
