<?php
/**
 * Template Name: Productions > Details contacts
 *
...
$getcolumns[] = array('id' => 'col_contactid', 'label'=>'Contact ID');
$getcolumns[] = array('id' => 'col_firstname', 'label'=>'Firstname');
$getcolumns[] = array('id' => 'col_surname', 'label'=>'Lastname');
$getcolumns[] = array('id' => 'col_venue', 'label'=>'Company');
$getcolumns[] = array('id' => 'col_email', 'label'=>'E-mail');
$getcolumns[] = array('id' => 'col_telnr', 'label'=>'Telephonenr');
