<?php
/**
 * Template Name: Productions > Browse
 *
...
$getcolumns[] = array('id' => 'col_prodid', 'label'=>'Production ID');
$getcolumns[] = array('id' => 'col_name', 'label'=>'Productionname');
$getcolumns[] = array('id' => 'col_artists', 'label'=>'Artists');
$getcolumns[] = array('id' => 'col_datestart', 'label'=>'Date start');
$getcolumns[] = array('id' => 'col_dateend', 'label'=>'Date end');
