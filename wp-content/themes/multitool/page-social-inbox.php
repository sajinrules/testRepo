<?php
/**
 * Template Name: We Cross Social Inbox
 *
...
<div class="wrap">
	...
	<form method="post">
		...
		<p class="search-box">
		<label for="simple_inbox-search-type"><?php _e('Type:','simple_social_inbox');?></label>
		<select id="simple_inbox-search-type" name="search[type]">
			<option value=""><?php _e('All','simple_social_inbox');?></option>
