<?php
/**
 * Template Name: Productions > Details Channels
 *
...
$getcolumns[] = array('id' => 'col_cid', 'label'=>'Channel ID');
$getcolumns[] = array('id' => 'col_typeicon', 'label'=>'typeicon');
$getcolumns[] = array('id' => 'col_type', 'label'=>'type');
$getcolumns[] = array('id' => 'col_name', 'label'=>'Channelname');
$getcolumns[] = array('id' => 'col_channelid', 'label'=>'Channel ID');
$getcolumns[] = array('id' => 'col_uri', 'label'=>'URI');
$getcolumns[] = array('id' => 'col_incname', 'label'=>'Include Name');
...
switch($choosetype){
	case 0:
	$typeicon = '<img src="http://engine.intothetune.com/img/social/youtube.png">';
	$type = "media";
		break;
	case 1:
	$typeicon = '<img src="http://engine.intothetune.com/img/social/soundcloud.png">';
	$type = "soundcloud";
		break;
	case 2:
	$typeicon = '<img src="http://engine.intothetune.com/img/social/vimeo.png">';
	$type = "media";
		break;
	case 3:
	$typeicon = '<img src="http://engine.intothetune.com/img/social/lastfm.png">';
	$type = "media";
		break;
	case 4:
	$typeicon = '<img src="http://engine.intothetune.com/img/social/facebook.png">';
	$type = "facebook";
		break;
}	
...
$data[] = array(
	...
	'type' => $type,
	'name' => 'Channelname',
	'channelid' => 'channeluserunique-name-id',
	'uri' => 'http://etc',
	'includename' => 'yes'
);
$i++;
