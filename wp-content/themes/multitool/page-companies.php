...
$getcolumns[] = array('id' => 'col_compid', 'label'=>'Company ID');
$getcolumns[] = array('id' => 'col_name', 'label'=>'Companyname');
$getcolumns[] = array('id' => 'col_artists', 'label'=>'Artists');
$getcolumns[] = array('id' => 'col_comptype', 'label'=>'Company Type');
...
$data[] = array(
	...
	'comptype' => 'label, concerthall, selfsigned artist etc.',
);
$i++;
}
?>
