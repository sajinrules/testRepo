...
class WC_Report_Carts_By_Product extends WC_Admin_Report {
	...
	public function products_widget() {
		...
		<div class="section">
			<form method="GET">
				<div>
					<select id="product_ids" name="product_ids[]" class="ajax_chosen_select_products" multiple="multiple" data-placeholder="<?php _e( 'Search for a product&hellip;', 'woocommerce_cart_reports' ); ?>" style="width:203px;"></select>
					<input type="submit" class="submit button" value="<?php _e( 'Show', 'woocommerce_cart_reports' ); ?>" />
