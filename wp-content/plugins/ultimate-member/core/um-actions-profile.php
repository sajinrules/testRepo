<?php
	...
	***/
	...
	function um_add_submit_button_to_profile($args){
		...
		<div class="um-col-alt">
			...
			<div class="um-left um-half"><input type="submit" value="<?php echo $args['primary_btn_word']; ?>" class="btn green-haze" /></div>
			<!--<div class="um-right um-half"><a href="<?php //echo um_edit_my_profile_cancel_uri(); ?>" class="btn default"><?php //echo $args['secondary_btn_word']; ?></a></div>-->
	...
	***/
	...
	function um_profile_navbar( $args ) {
		...
		<div class="um-profile-navdsf" style="display: none;">
