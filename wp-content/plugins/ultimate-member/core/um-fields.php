		...
		switch( $type ) {
			...
			case 'soundcloud_track':
				...
				$output .= '<div class="um-field' . $classes . '"' . $conditional . ' data-key="'.$key.'">';
						...
						$output .='<input type="'.$input.'"  class="form-control" name="'.$key.$ultimatemember->form->form_suffix.'" id="'.$key.$ultimatemember->form->form_suffix.'" value="'. htmlspecialchars( $this->field_value( $key, $default, $data ) ) .'" placeholder="'.$placeholder.'" data-validate="'.$validate.'" data-key="'.$key.'" /> ';
			...
			case 'text':
				...
				//$output .= '<div class="um-field' . $classes . '"' . $conditional . ' data-key="'.$key.'">';
						$output .='<div class="form-group" style="width:50%">';
			...
			case 'url':
				...
				//$output .= '<div class="um-field' . $classes . '"' . $conditional . ' data-key="'.$key.'">';
					$output .='<div class="form-group" style="width:50%">';	
						...
						$output .= '<input class="form-control" type="'.$input.'" name="'.$key.$ultimatemember->form->form_suffix.'" id="'.$key.$ultimatemember->form->form_suffix.'" value="'. $this->field_value( $key, $default, $data ) .'" placeholder="'.$placeholder.'" data-validate="'.$validate.'" data-key="'.$key.'" />
			...
			case 'textarea':
				...
				$output .='<div class="form-group" style="width:50%">';		
						...
						//</div>';
						$output .= '<textarea style="height: '.$height.';" class="form-control" name="'.$key.'" id="'.$key.'" placeholder="'.$placeholder.'">'.$this->field_value( $key, $default, $data ).'</textarea>';
