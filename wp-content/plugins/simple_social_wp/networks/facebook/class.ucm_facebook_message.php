...
class ucm_facebook_message{
	...
	public function mark_as_read(){
		if($this->social_facebook_message_id && get_current_user_id()){
			$sql = "REPLACE INTO `"._SIMPLE_SOCIAL_DB_PREFIX."social_facebook_message_read` SET `social_facebook_message_id` = ".(int)$this->social_facebook_message_id.", `user_id` = ".(int)get_current_user_id().", read_time = ".(int)time();
			ucm_query($sql);
		}
	}
