...
class ucm_facebook_group{
	...
	public function link_refresh(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&manualrefresh&social_facebook_id='.$this->get('social_facebook_id').'&facebook_group_id='.$this->get('group_id');
	}
