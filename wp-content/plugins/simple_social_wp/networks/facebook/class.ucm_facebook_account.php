...
class ucm_facebook_account{
	...
	public function link_connect(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&fbconnect&social_facebook_id='.$this->get('social_facebook_id');
	}
	public function link_edit(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&social_facebook_id='.$this->get('social_facebook_id');
	}
	public function link_new_message(){
		return 'admin.php?page=simple_social_inbox_main&social_facebook_id='.$this->get('social_facebook_id').'&social_facebook_message_id=new';
	}

	public function link_refresh(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&manualrefresh&social_facebook_id='.$this->get('social_facebook_id').'&facebook_feed=true';
	}
	public function link_refresh_groups(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&manualrefresh&social_facebook_id='.$this->get('social_facebook_id').'&refresh_data=groups';
	}
	public function link_refresh_pages(){
		return 'admin.php?page=simple_social_inbox_facebook_settings&manualrefresh&social_facebook_id='.$this->get('social_facebook_id').'&refresh_data=pages';
	}
