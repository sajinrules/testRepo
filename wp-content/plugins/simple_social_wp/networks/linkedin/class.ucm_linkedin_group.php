...
//		$api_result = $api->api('v1/groups/'.$linkedin_group_id.'/posts?order=recency&category=discussion');
	...
	public function link_refresh(){
		return 'admin.php?page=simple_social_inbox_linkedin_settings&manualrefresh&social_linkedin_id='.$this->get('social_linkedin_id').'&linkedin_group_id='.$this->get('group_id');
	}
