ucm.social.google = {
            ...
            if(txt.length > 0){
                ...
                if(message.length > 0){
                    ...
                    jQuery.ajax({
                        ...
                        method: 'POST',
                        data: {
                            action: 'simple_social_send-message-reply',
                            wp_nonce: simple_social.wp_nonce,
    ...
    message_action: function(link){
        jQuery.ajax({
            ...
            method: 'POST',
            data: {
                action: 'simple_social_'+jQuery(this).data('action'),
                wp_nonce: simple_social.wp_nonce,
...
,"0z12xdbkpryi4ujhxp04cd1tpun3zvrsxzow0k",[[["","","Google+","Simple Social Inbox","Testing a G+ Page Post\ufeff",1398836406547,"http://www.google.com/favicon.ico",[]
...
,0,[]
,0,0,,,[]
,,,,"https://plus.google.com/117852760669160280054/posts/XM7sDRSgJCq",,,1,,["Simple Social Inbox","117852760669160280054",0,0,"","./117852760669160280054"]
...
,"0z12hflbj5wb5ez2lu22cihioszyxybjxb04",[[["","","Google+","Simple Social Inbox","test test\ufeff",1398920588454,"http://www.google.com/favicon.ico",[[,"David Baker","Testing a comment on a page post\ufeff",1398996547872,"z12hflbj5wb5ez2lu22cihioszyxybjxb04#1398996547872468",,"117903403161141413513","z12hflbj5wb5ez2lu22cihioszyxybjxb04",0,0,"./117903403161141413513",0,,,0,[,,,,,,,,,,,,[]
,,,,,[]
,0]
...
,[,"Simple Social Inbox","test reply\ufeff",1398999831567,"z12hflbj5wb5ez2lu22cihioszyxybjxb04#1398999831567366","test reply","117852760669160280054","z12hflbj5wb5ez2lu22cihioszyxybjxb04",0,0,"./117852760669160280054",0,1,,0,[,,,,,,,,,,,,[]
,,,,,[]
,0]
,"",,,,,,,0,,["Simple Social Inbox","117852760669160280054",0,0,"","./117852760669160280054"]
,["en",0,"English"]
,[[[0,"test reply\ufeff"]
]
]
...
,["Simple Social Inbox","117852760669160280054",1,1,"","https://plus.google.com/117852760669160280054","other"]
]
,,,0,9,,,[]
,0,[]
,0,0,,,[]
,,,,"https://plus.google.com/117852760669160280054/posts/AiTcCab3JVF",,,1,,["Simple Social Inbox","117852760669160280054",0,0,"","./117852760669160280054"]
,[[[0,"test test\ufeff"]
]
]
,,,,["en",0,"English"]
...
,1.398997296662001E15,,1,,,1,,[["Simple Social Inbox","https://plus.google.com/117852760669160280054","https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg","117852760669160280054","other",0,"Simple Social Inbox",".",""]
