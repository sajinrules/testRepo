			       ...
			       'google_account' => array(
				    ...
				    /*'schedule' => array(
					    ...
					    'fields' => array(
						    ...
						    ' ',
						    __('Currently: %s', 'simple_social_inbox'date('c')),
...
<script type="text/javascript" src="<?php echo _BASE_HREF;?>includes/plugin_social_google/js/jquery.charactercounter.js"></script>

	    <script type="text/javascript">
		    function google_set_limit(limit){
			    $("#google_compose_message").characterCounter({
		    ...
		    function change_post_type(){
			    ...
			    if(currenttype == 'picture'){
				    google_set_limit(119);
			    }else{
				    google_set_limit(140);
			    }
