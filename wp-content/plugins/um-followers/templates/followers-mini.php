...
<?php } else { ?>
	...
	<p><?php echo ( $user_id == get_current_user_id() ) ? __('You do not have any followers yet.','ultimatemember') : __('This user do not have any followers yet.','ultimatemember'); ?></p>
