<div class="um um-shortcode-social" id="um-shortcode-social-<?php echo $id; ?>" style="padding:<?php echo $padding; ?>;margin:<?php echo $margin; ?>!important;">
		...
		<div class="um-field">
			...
			<div class="um-col-alt">
				...
				<div <?php if ( $button_style == 'floated' ) { echo 'style="display:inline"'; } ?> class="<?php if ( $button_style == 'responsive' ) echo $class . ' um-half'; ?>"><a href="<?php echo $um_social_login->login_url( $provider ); ?>" title="<?php echo $arr['button']; ?>" class="um-button um-alt um-button-social um-button-<?php echo $provider; ?>"><?php if ( $show_icons ) { ?><i class="<?php echo $arr['icon']; ?>" <?php if ( $show_labels ) { echo 'style="margin-right: 8px;"'; } ?>></i><?php } ?><?php if ( $show_labels ) { ?><span><?php echo $arr['button']; ?></span><?php } ?></a></div><?php if ( $button_style == 'default' ) { ?><div class="um-clear"></div><?php } ?>
