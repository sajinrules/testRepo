...
class CPM_Router {
     ...
     */
	function includes() {
		require_once CPM_PATH . '/includes/urls.php';
        require_once CPM_PATH . '/includes/html.php';
        require_once CPM_PATH . '/includes/shortcodes.php';
	}
	...
	function cpm_function() {
		require_once CPM_PATH . '/includes/functions.php';
	}
