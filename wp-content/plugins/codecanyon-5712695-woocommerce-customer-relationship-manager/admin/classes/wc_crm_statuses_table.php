...
class WC_CRM_Statuses_Table extends WP_List_Table {
  ...
  function column_status_name( $item ) {
    ...
    $actions = array(
      'edit'      => sprintf('<a href="admin.php?page=wc_crm_settings&tab=statuses&action=%s&id=%s">Edit</a>', 'edit', $item['status_id']),
      'delete'      => sprintf('<a href="admin.php?page=wc_crm_settings&tab=statuses&action=%s&id=%s">Delete</a>', 'delete', $item['status_id']),
    );

    $name = sprintf(
        '<strong><a href="admin.php?page=wc_crm_settings&tab=statuses&action=%s&id=%s">%s</a></strong>', 'edit', $item['status_id'], $item['status_name']
    );
