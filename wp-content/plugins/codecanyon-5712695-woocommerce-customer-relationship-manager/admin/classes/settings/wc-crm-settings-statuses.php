...
class WC_Crm_Settings_Customer_Status extends WC_Settings_Page {
	...
	public function output()
	{
	    ...
	    <div class="wrap">
	      ...
	      <form method="post" action="" enctype="multipart/form-data" id="wc_crm_customer_statuses">
	        ...
	        <p><a href="<?php echo admin_url('admin.php?page=wc_crm_settings&tab=statuses'); ?>"><?php _e('Back to statuses list', 'wc_customer_relationship_manager'); ?></a></p>
	...
	public function save() {
		...
		if(!isset($_GET['page']) || $_GET['page'] != 'wc_crm_settings')
			return;
