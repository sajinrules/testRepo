...
<div class="wpallimport-collapsed wpallimport-section">
	...
	<div class="wpallimport-content-section">
		...
		<?php if ( "new" == $post['wizard_type']): ?>	
			...
			<?php else: ?>
				<h3 style="padding-left:0;"><?php printf(__('WP All Import will create new %s for each unique record in your file.','pmxi_plugin'), $custom_type->labels->singular_name);?></h3>	
			<?php endif; ?>			
			</div>
