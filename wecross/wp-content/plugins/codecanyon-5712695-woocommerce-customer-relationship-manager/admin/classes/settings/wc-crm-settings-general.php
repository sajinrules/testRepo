	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_customer_relationship_general_settings_fields', array(
			...
			array(
					...
					'desc'    => 'Choose which statuses the customer orders must be before appearing in the Value column.',
			...
			array(
				'title'         => __( 'Automatic Emails', 'woocommerce' ),
				'desc'          => 'Check this box to send an email with username and password when creating a new customer.',
