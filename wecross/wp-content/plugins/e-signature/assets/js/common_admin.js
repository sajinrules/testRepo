(function ($) {
    ...
    if (signature_text) {
        ...
        var htmlcontent = '<div class="sign-here pad signed esig-sig-type esig-signature-type-font' + font + '" width="500" height="100"><span class="sign-text">' + signature_text + '</span></div>';
    ...
    $('#esig-type-in-text-accept-signature').click(function () {
        ...
        var htmlcontent = '<div class="sign-here pad signed esig-sig-type esig-signature-type-font' + font + '" width="500" height="100"><span class="admin-sig-type">' + signature_type + '</span></div>';
        htmlcontent += '<input type="hidden" name="esig_signature_type" value="typed">';
