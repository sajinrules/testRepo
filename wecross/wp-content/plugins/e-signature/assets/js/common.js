(function ($) {
        ...
        if($(e).find('.esignature-in-text-signed'))
         {
            ...
            if (signature_text) {
                ...
                var htmlcontent = '<div class="sign-here pad signed esig-sig-type esig-signature-type-font' + font + '" width="400" height="100"><span class="sig-type">' + signature_text + '</span></div>';
    ...
    $('body').on('click', '#esig-type-in-change-fonts', function () {
