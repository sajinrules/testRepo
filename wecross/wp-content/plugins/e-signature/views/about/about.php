...
<div class="esign-wp-badge">
	...
	<a href='//www.approveme.me/wp-digital-e-signature/?ref=5' target='_blank'>
...
<div class="esign-changelog">
	<div class="esign-feature-section esign-col esign-two-col">
		<div>
			<p align="left" class="feature-text"><span class="esign-icon-secure"></span><span class="feature-list esign-about-features-a">Secure and encrypted.</span>
            Security is our top priority. All of your signed documents and signatures are kept hidden and encrypted on your server at all times, using a GUID encryption sequence.
			</p>
			
			<p align="left" class="feature-text"><span class="esign-icon-audit"></span><span class="feature-list esign-about-features-a">Audit report.</span>
			Documents move turbo speed from signer to signer. We include a detailed audit report with viewer details, ip addresses, document analytics, document id# and signer history.
			</p>
			
		<p align="left" class="feature-text"><span class="esign-icon-smarter"></span><span class="feature-list esign-about-features-a">No monthly fees.</span>
		WP E-Signature is the easiest and most affordable way to sign documents. You have full control over your data – it never leaves your server. Built for WordPress.
		</p>
			
		</div>
		<div class="esign-last-feature esign-col esign-two-col">
			<p align="left" class="feature-text"><span class="esign-icon-legal"></span><span class="feature-list esign-about-features-a">Legally binding.</span>
			WP E-Signature is recognized in court. We are (UETA) and (ESIGN) compliant and adhere to some of the strictest document signing policy's in the US and European unions.
			</p>
			
			<p align="left" class="feature-text"><span class="esign-icon-integrated"></span><span class="feature-list esign-about-features-a">Automate signing documents.</span>Tired of having to manually send out your NDA contract, Terms of Service, Patient in take form, Insurance Documents etc. Now you can automate the process.
			</p>
			
			<p align="left" class="feature-text"><span class="esign-icon-wallet"></span><span class="feature-list esign-about-features-a">Tablet &amp; Cell Phone Friendly.</span>Upload documents via WordPress dashboard and collect real client signatures through your website. Users sign documents using their mouse, trackpad, tablet, or phone.
			</p>
		</div>
	</div>
</div>
...
<div class="esign-changelog">
	<div class="esign-feature-section esign-col esign-two-col">
		<div>
			<h3>No Monthly Fees (we're serious)</h3>
			
			<p>Our goal with WP E-Signature all along has been to create a FREE document signing alternative to the monthly service fees currently associated with the document signing industry. We make it ridiculously easy to sign documents from your very own WordPress website, send document signer invites, and save a ton of money by canceling your current monthly e-signature service (no monthly fees with us). </p>
	
			
			<h4>You have full control over your document(s).</h4>
			<p>Each signature, document, and data related to your document is encrypted and stored in your very own website database.  Because documents are saved on your website server (and not a third party server), you can save lots of money by using WP E-Signature.</p>
...
<div class="esign-changelog about-twentyfourteen">
	<h2 class="esign-about-headline-callout">Customize E-Signature with ADD-ONS!</h2>
	<p align='center'>You can customize your Document Signing workflow to work with many of our E-Signature add-on extensions.</p>
	
	<a href='//www.approveme.me/wp-digital-e-signature/wordpress-electronic-digital-signature-add-ons?ref=6' target='_blank'><img src='<?php echo $data['ESIGN_ASSETS_URL']; ?>/images/about/add-on-screenshots.png' class='esig-about-addon'/></a>

	<div class="esign-feature-section esign-col esign-one-col esign-center-col">
		<div>
			
			<p align='center'><a class='esign-red-btn-lrg wp-e-saveButton esign-blue-btn' href='admin.php?page=esign-settings'>Let's Start Signing Documents!</a></p>
...
<div class="esign-return-to-dashboard">
		<a href='index.php'>Go to Dashboard &rarr; Home</a>
</div>
