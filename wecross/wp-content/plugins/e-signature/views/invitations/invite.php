                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              bgcolor="#F7FAFC"><?php echo $data['user_full_name']; ?> <?php _e('has requested your signature', 'esig' );?></td>
                          </tr>
                        </tbody>
                      </table>
                      <table width="100%">
                          ...
                          <tr>
                            <td
                              ...
                              <p
                                ...
                                0px"> <span style="color:#8c8c8c"><?php _e('From:','esig');?> <?php echo $data['user_full_name']; ?> (<a
                                    href="mailto:<?php echo $data['user_email']; ?>"
                                    target="_blank"><?php echo $data['user_email']; ?></a>)
                                </span> </p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                style="line-height:1.4em;font-size:14px;margin:10px
                                0px"><?php _e('Hi','esig'); ?> <?php echo $data['recipient_name']; ?>,<br>
                                ...
                                <br>
                                <?php echo $data['user_full_name']; ?> <?php _e('sent you a document that needs to be signed.', 'esig' ); ?><br>
                                <br>
                                <?php _e('Please add your signature to the document below.', 'esig' );?>  - <a
href="mailto:<?php echo $data['user_email']; ?>?subject=RE%3A%20%7B<?php echo $data['document_title']; ?>%7D"
style="color:#368bc6;text-decoration:none" target="_blank"><?php _e('Got a Question?', 'esig' );?><br>
                                </a></p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p style="margin:10px 0px;font-size:14px;line-height:1.4em;color:#ff0000">
                              	<?php _e('Warning: do not forward this email to others or else they will have access to your document (on your behalf).', 'esig' );?></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
Neue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse"
              ...
              <table style="margin-top:20px" border="0" cellpadding="20"
                ...
                <tbody>
                  <tr style="border-collapse:collapse">
                    <td style="padding: 16px 12px 0px 20px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;"
                      align="left"><?php echo sprintf( __( 'This message was sent to you by %s who is using the WP E-Signature Document Signing WordPress plugin. If you would rather not receive email from this sender you may contact the sender with your request.', 'esig'), $data['user_full_name'] );?> </td>
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                    ...
                    <td style="padding:0px 0px 0px
                      0px;vertical-align:top;font-family:'Helvetica
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                      align="center"> <a href="https://www.approveme.me/security-ueta-e-sign-protection/" target="_blank"><img
src="<?php echo $data['assets_dir']; ?>/images/verified-email.jpg"
                              alt="WP E-Signature" border="0" style="margin-top: -8px;"
                              height="69" width="200"></a><br>
                    </td>
                  </tr>
                </tbody>
              </table>
