...
<div id=":zs" class="ii gt m1436f203bed358e3 adP adO">
  <div id=":zr" style="overflow: hidden;">
    <div class="adM"> </div>
    <div
style="background-color:#efefef;margin:0;padding:0;font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;width:100%;">
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                               ...
                               <?php _e(' Audit Trail Serial Number  #:','esig');?> <?php echo $data['document_id']; ?>
                                </p>
                              <hr
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
					...
					<a href="http://www.approveme.me/?ref=1" target="_blank"><img
