                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              bgcolor="#F7FAFC"><?php echo $data['signer_name']; ?> <?php _e('has signed your document','esig'); ?> </td>
                          </tr>
                        </tbody>
                      </table>
                      <table width="100%">
                            ...
                            <td
                             ...
                             <?php _e('Document ID:', 'esig' );?> (<?php echo $data['document_checksum']; ?>)
                              <p
                                ...
                                0px"> <span style="color:#8c8c8c"><?php _e('From:','esig');?> <?php echo $data['owner_first_name'] . " " . $data['owner_last_name']  ; ?> (<a
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <br>
                                <?php echo $data['signer_name']; ?> (<?php echo $data['signer_email']; ?>) <?php _e('has signed your document.','esig'); ?><br>
                                
							<?php
							
							if(!empty($data['document_id']))
							{
									 _e(' Audit Trail Serial Number  #:','esig');?> <?php echo $data['document_id']; 
							 }
							 ?>
                                </p>
                              <hr
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>
                                       ...
                                       <?php _e('View Signed Document','esig'); ?></a></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p style="margin:10px 0px;font-size:14px;line-height:1.4em;color:#ff0000">
                              	<?php _e('Warning: do not forward this email to others or else they will have access to your document (on your behalf).', 'esig' );?></p></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                    ...
                    <td style="padding:0px 0px 0px
                      0px;vertical-align:top;font-family:'Helvetica
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                      align="center"> <a href="http://www.approveme.me/?ref=1" target="_blank"><img
