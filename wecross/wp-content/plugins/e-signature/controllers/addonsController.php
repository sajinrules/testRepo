...
class WP_E_addonsController extends WP_E_appController 
{
    ...
    */
    public function index()
	{
        ...
        {
               $installed= $this->model->esig_addons_update($_GET['download_url'],$_GET['download_name']);
               ...
               if($installed)
               {
                   //going to activate the plugin .
					...
					$msg= sprintf(__('<strong>E-signature Plugin</strong> : %s Updated successfully.',$plugin_file, 'esig'),$plugin_file); 
               }               
        }
