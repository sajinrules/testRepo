<h3>E-signature Roles</h3>

 <?php if(isset($data['message'])){ echo $data['message']; } ?>

<form name="esig_roles_form" class="roles-form" method="post" action="">	
<table class="form-table">
	...
	<p>
		<input type="submit" name="misc-submit" class="button-appme button" value="<?php  _e('Save Settings','esig-usr'); ?>" />
	</p>
</form>
