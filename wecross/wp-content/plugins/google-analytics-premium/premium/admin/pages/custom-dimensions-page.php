...
<div class="ga-form ga-form-input">
	...
	<table id="yoast-ga-form-label-table-settings-custom_dimensions" class="widefat fixed" width="100%">
		...
		<th align="left" colspan="2">
			<i><?php printf( __( 'You are using <span id="yst-ga_limit">%1$s</span> out of %2$s custom dimensions', 'ga-premium' ), $this->custom_dimensions_usage, $this->custom_dimensions_limit ); ?></i>
		</th>
		</tfoot>
	</table>
