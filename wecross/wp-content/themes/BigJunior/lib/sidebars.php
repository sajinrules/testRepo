...
register_sidebar( array(
        'name' => __( 'Algemene Informatie Sidebar', TEXTDOMAIN ),
        'id' => 'wecross-info-sidebar',
	    'before_widget' => '<div id="%1$s" class="widget %2$s">',
	    'after_widget' => '</div>',
	    'before_title' => '<h4 class="widget-title">',
	    'after_title' => '</h4><hr class="hr-medium" />',
...
register_sidebar( array(
        'name' => __( 'Publicatie Sidebar', TEXTDOMAIN),
        'id' => 'wecross-publicatie-sidebar',
	    'before_widget' => '<div id="%1$s" class="widget %2$s">',
	    'after_widget' => '</div>',
	    'before_title' => '<h4 class="widget-title">',
	    'after_title' => '</h4><hr class="hr-medium" />',
...
register_sidebar( array(
        'name' => __( 'Whitepaper Sidebar', TEXTDOMAIN),
        'id' => 'wecross-whitepaper-sidebar',
	    'before_widget' => '<div id="%1$s" class="widget %2$s">',
	    'after_widget' => '</div>',
	    'before_title' => '<h4 class="widget-title">',
	    'after_title' => '</h4><hr class="hr-medium" />',
...
register_sidebar( array(
        'name' => __( 'Formulier Sidebar', TEXTDOMAIN),
        'id' => 'wecross-formulier-sidebar',
	    'before_widget' => '<div id="%1$s" class="widget %2$s">',
	    'after_widget' => '</div>',
	    'before_title' => '<h4 class="widget-title">',
	    'after_title' => '</h4><hr class="hr-medium" />',
